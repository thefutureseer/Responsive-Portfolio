...
<html lang="en-us">
  <head>
    ...
    <title>Tannehill</title>
    <!-- Boostrap Stylesheet -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    <!-- CSS stylesheet -->
    <link rel="stylesheet" href="assets/css/style.css" media="screen">
   <!-- <link rel="stylesheet" href="assets/css/stylesContact.css" media="screen"> -->
  </head>
  <body>
    <!-- Start navbar -->
    <nav class="navbar navbar-default">
      <div class="container-fluid navbar-custom">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" id="logo">Daniel Tannehill</a>
        </div>
          ...
          <div class="col-md-4">
            ...
            <section id="connect-with-me-area">
              <div class="connect-with-me-content">
                ...
                <hr />
                <div id="images">
                 <img src="https://raw.githubusercontent.com/thefutureseer/Responsive-Portfolio/master/assets/css/images/github.png" alt="" class="connect-with-me-photo">
                 <img src="https://raw.githubusercontent.com/thefutureseer/Responsive-Portfolio/master/assets/css/images/linkedin.png" alt="" class="connect-with-me-photo"> 
                 <img src="https://raw.githubusercontent.com/thefutureseer/Responsive-Portfolio/master/assets/css/images/stackover2.png" alt="" class="connect-with-me-photo"> 
                </div>
              </div>
            </section>
            <!-- End Connect With Me Area -->
          </div>
        </section>
      </div>
    </div>
    ...
    <footer class="footer">
      ...
      <p class="text-muted text-muted-footer text-center">
        &copy; Copyright 2017 Daniel Tannehill
      </p>
    </footer>
    <!-- End of footer -->
    <!-- jQuery CDN -->
